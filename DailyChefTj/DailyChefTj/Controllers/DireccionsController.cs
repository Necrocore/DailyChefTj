...
namespace DailyChefTj.Controllers
{
    public class DireccionsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Calle,CodigoPostal,Fraccionamiento")] Direccion direccion)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Calle,CodigoPostal,Fraccionamiento")] Direccion direccion)
        {
            if (ModelState.IsValid)
            {
